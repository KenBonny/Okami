...
This app helps you remember what is in your freezer, when you put it in and when it will expire. <span class="first-warning">3 months before expiry</span>, items will colour light orange/yellow, <span class="second-warning">a month before expiry</span> the items will colour dark orange and <span class="expired">after expiry</span> they will colour red. This is to help you identify items that need to be consumed before they expire or to remove expired items.
